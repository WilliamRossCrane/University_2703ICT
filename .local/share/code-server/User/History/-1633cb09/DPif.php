...
// Step 4: Implement input validation function.
...
<!-- Step 5: Display error message if present -->
<?php if (!empty($error)) { ?>
    <p class="alert"><?php echo $error; ?></p>
<?php } ?>

<!-- Step 6: Display search form -->
...
<!-- Step 7: Display search results if there are any -->
<?php if (count($pms) > 0) { ?>
